...
In order to use a HD with Nextcloud the mounting folder must be setted as following permission code 0770. See [nextcloud.md](../web-server/nextcloud.md "mention")
